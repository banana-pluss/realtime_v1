...
public class ProcessSpiltStream extends ProcessFunction<JSONObject,String> {
    ...
    public ProcessSpiltStream(OutputTag<String> errTag,OutputTag<String> startTag,OutputTag<String> displayTag,OutputTag<String> actionTag) throws Exception {
