...
//        cdcDbMainStreamMap.print();
        ...
        cdcDbMainStream.sinkTo(
                KafkaUtils.buildKafkaSink(ConfigUtils.getString("kafka.bootstrap.servers"),"gmall_mysql_db")
        ).uid("sink_to_kafka_gmall_mysql_db").name("sink_to_kafka_gmall_mysql_db");
