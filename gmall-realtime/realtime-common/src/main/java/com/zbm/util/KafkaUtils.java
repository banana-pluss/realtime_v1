...
public final class KafkaUtils {
    ...
    public static void sendDataToKafka(String tableName, JSONObject jsonObject) {
        Properties producerProps = new Properties();
        producerProps.put("bootstrap.servers", ConfigUtils.getString("kafka.bootstrap.servers"));
